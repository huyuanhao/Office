...
//	private Map<String, Object>	items				= new HashMap<String, Object>();
    ...
    public String getDataStr() {
        ...
        if (!TextUtils.isEmpty(jsonStr)) {
            try {
                ...
                if (code.equals(Constants.SUCCESS_CODE)) {
                    ...
                    dataJsonArrayStr =  data.toString();
                }
        ...
        return dataJsonArrayStr;
    }


    public String getDataDataStr() {
        String dataJsonArrayStr = null;
        if (!TextUtils.isEmpty(jsonStr)) {
            try {
                JSONObject jsonObject = new JSONObject(jsonStr);
                ...
                if (code.equals(Constants.SUCCESS_CODE)) {
                    ...
                    JSONArray data1 = jsonObject1.optJSONArray("DATA");
                    dataJsonArrayStr = data1.toString();
                }
            } catch (JSONException e) {
                e.printStackTrace();
            }
    ...
    public ResultItem(LinkedHashMap<String, Object> mapObj) {
        items.putAll(mapObj);
    }
