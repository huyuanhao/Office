...
//            PERMISSION_GET_ACCOUNTS,
    ...
    public static final int[] NEEDED_PERMISSIONS = {
//            CODE_RECORD_AUDIO,//这个是录音需要的权限
            CODE_READ_PHONE_STATE,//获取当前sd信息权限
            CODE_CAMERA,//拍照权限
            CODE_READ_EXTERNAL_STORAGE,//读sd卡权限
            CODE_WRITE_EXTERNAL_STORAGE//写sd卡权限
    };
...
//        }
    ...
    public static void requestMultiPermissions(final Activity activity, PermissionGrant grant) {
        ...
        if (permissionsList.size() > 0) {
            ...
            showMessageOKCancel(activity, "需要打开一些权限",
