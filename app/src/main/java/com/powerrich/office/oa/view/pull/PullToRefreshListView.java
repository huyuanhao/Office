...
import com.powerrich.office.oa.view.pull.ILoadingLayout.State;
...
public class PullToRefreshListView extends PullToRefreshBase<ListView> implements OnScrollListener {
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
        if (isScrollLoadEnabled() && hasMoreData()) {
        	//开始滚动：SCROLL_STATE_FLING,		停止滚动：SCROLL_STATE_IDLE,	正在滚动：SCROLL_STATE_TOUCH_SCROLL
    ...
    public void setFooterText(String text){
    	if(mLoadMoreFooterLayout != null)
    		mLoadMoreFooterLayout.onText(text);
    }
    ...
    public void hideMoreFooterLayout(boolean flag) {
    	mLoadMoreFooterLayout.show(flag);
    }

	public void hideMoreFooterLayout() {
		mLoadMoreFooterLayout.show(false);
	}
}
