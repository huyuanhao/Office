...
public class AutoScrollTextView extends TextSwitcher implements ViewSwitcher.ViewFactory{
    ...
    private Rotate3dAnimation createAnim( boolean turnIn, boolean turnUp){
        ...
        rotation.setDuration(800);//执行动画的时间
    ...
    public View makeView() {
        ...
        textView.setLayoutParams(new ViewSwitcher.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,LinearLayout.LayoutParams.MATCH_PARENT));
        textView.setGravity(Gravity.LEFT);
        textView.setTextSize(TypedValue.COMPLEX_UNIT_PX,46);
