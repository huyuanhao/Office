...
public class PermissionPageUtils {
    ...
    public static final int CODE_REQUEST_CAMERA_PERMISSIONS = 0101;
    private static Context mContext;
    //自己的项目包名
    private String packageName = "com.powerrich.office.oa";

    public static PermissionPageUtils getInstance(Context context) {
        mContext = context;
        return new PermissionPageUtils();
    }
     ...
     * 提示开启权限
     */
    public static void showTipDialog(final Context context, String message) {
            MyDialog.showDialog(context, "权限通知", message, new MyDialog.InterfaceClick() {
                @Override
                public void click() {
...
//        mContext.startActivity(intent);
        ...
        if (getAppDetailSettingIntent() != null) {
