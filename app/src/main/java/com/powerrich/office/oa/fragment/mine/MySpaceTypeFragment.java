 ...
 * 版权：
 */
public class MySpaceTypeFragment extends BaseRefreshFragment<ProcessInfo> implements NotificationListener {

    Unbinder unbinder;
    private SearchFragmentType type;
    boolean longboo = false;
    MySpaceActivity mActivity;
//    private LoadingDialog dialog;

    public static MySpaceTypeFragment getInstance(SearchFragmentType type) {
        MySpaceTypeFragment fragment = new MySpaceTypeFragment();
        Bundle b = new Bundle();
