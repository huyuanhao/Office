...
//        mHeaderImage = new ImageView(context);
        mHeaderImage = LayoutInflater.from(getContext()).inflate(R.layout.third_fragment_list_header_banner, null);//自定缩放布局
        int width = metrics.widthPixels;
//        setHeaderViewSize(width, (int) ((((float) width) / 16.0f) * 9.0f));//Screen Ratio = 16:9     1.5
        setHeaderViewSize(width, ScreenUtils.dp2px(context, 150));//固定高度为150
