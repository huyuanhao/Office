 ...
 * 描   述：个人、企业预约事项适配器
 * 作   者：chenhao
 * 时   间：2018-7-13 11:05:36
 * 版   权：v1.0
 */
public class BookingExpandableListViewAdapter extends BaseExpandableListAdapter {

    private Context context;
    private List<Items> itemsList;

    public BookingExpandableListViewAdapter(Context context, List<Items> itemsList) {
    ...
    public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        itemHolder.tv_todo.setText("立即预约");
        ...
        isEnabled(itemHolder.tv_todo, item.getSonItems().get(childPosition).getISAPPOINTMENT());
        return convertView;
    }
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        isEnabled(groupHolder.tv_todo, item.getISAPPOINTMENT());
    ...
    private void isEnabled(TextView tv, String isAppointment) {
        if ("1".equals(isAppointment)) {//判断是否可预约,为1才能预约
