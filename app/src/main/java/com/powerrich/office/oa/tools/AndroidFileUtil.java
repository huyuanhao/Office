...
import com.powerrich.office.oa.adapter.AttachmentListAdapter;
import com.powerrich.office.oa.bean.AttachmentInfo;
...
public class AndroidFileUtil {
     ...
     * 删除弹框
     */
    public static void deleteFileDialog(Context context, final String fileName, final AttachmentListAdapter adapter, final AttachmentInfo attachInfo) {
    ...
    public static String getGUID() {
        ...
        sb.append(java.util.UUID.randomUUID().toString().toUpperCase());
        while (sb.indexOf("-") != -1) {
    ...
    public static void openFile(Context context, File file) {
        ...
        try {
            ...
            e.printStackTrace();
            DialogUtils.showToast(context, "File corrupted, download again please.");
        }
