...
public class PinchImageView extends android.support.v7.widget.AppCompatImageView {
     ...
     * 在onTouchEvent末尾被执行.
     */
    private GestureDetector mGestureDetector = new GestureDetector(PinchImageView.this.getContext(), new GestureDetector
    ...
    public static class MathUtils {
         ...
         */
        public static void calculateScaledRectInContainer(RectF container, float srcWidth, float srcHeight, ScaleType
                scaleType, RectF result) {
